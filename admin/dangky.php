						...
						<form action="dangky_xuly.php" method="post" class="needs-validation" novalidate>
							...
							<div class="d-flex align-items-center justify-content-between mb-4">
								<div class="form-check">
									<input type="checkbox" class="form-check-input" id="exampleCheck1" onchange="SHPassword(this)">
							...
							<div class="d-flex align-items-center justify-content-between mb-4">
								<div class="form-check">
									<input type="checkbox" class="form-check-input" id="exampleCheck1" onchange="SHPassword1(this)">
									<label class="form-check-label" for="exampleCheck1">Hiện nhập lại mật khẩu</label>
								</div>
							</div>
