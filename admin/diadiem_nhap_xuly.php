...
<html lang="en">
	<head>
		...
		<title>Xử lý nhập địa điểm từ Excel - Bản đồ AGU</title>
	</head>
	<body>
		<div class="container">
			<!-- Menu: sử dụng navbar -->
		...
		<script type="module">
			import { getFirestore, doc, writeBatch, GeoPoint } from 'https://www.gstatic.com/firebasejs/9.6.8/firebase-firestore.js';
